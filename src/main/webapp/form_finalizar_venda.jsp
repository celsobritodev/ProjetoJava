...
<body>
	<div class="container-fluid">
        ...
        <table class="table table-striped table-bordered table-hover display" id="listaVenda">
           ...
           <tbody>
             ...
             <tr>
              ...
              <td><%=vp.getQtd() %> </td>
              <td><%=vp.getValorVendido() %><td>
              <td><%=vp.getQtd()*vp.getValorVendido() %> </td>
              <td align="center">
        ...
        <a href="form_venda.jsp?acao=c" class="btn btn-success">Continuar Vendendo</a>
